...
# [curriculum vitae](https://drive.google.com/file/d/1m_peQoGdHjLE8ZRAdHklRb6JqteGw9U6/view?usp=sharing)
<hr> <!-- Soft line after Curriculum Vitae -->

# 🎉 News
- *2026.02*: Our work on information-theoretic multimodal learning (details to come) was accepted to [CVPR 2026](https://cvpr.thecvf.com/)! See you in Denver :)
- *2026.01*: Our work on transferable self-supervised learning (details to come) was accepted to [ICLR 2026](https://iclr.cc/)! See you in Rio 🇧🇷
