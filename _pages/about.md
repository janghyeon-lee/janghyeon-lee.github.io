...
My research interests lie in **(1) out-of-distribution (OOD) generalization** and **(2) computational efficiency** for building effective and efficient foundation models. I study (1) how these models learn transferable representations across diverse domains and tasks, and (2) whether all data is truly useful for training foundation models.
