...
My research interests lie in understanding the learning phases of neural networks, motivated by parallels to how humans learn (e.g., [critical periods](https://en.wikipedia.org/wiki/Critical_period)). By identifying when and where networks acquire and consolidate information, I aim to improve training efficiency and model generalization.
