...
My research interests lie in machine learning (ML), with a focus on the **spatiotemporal domain (space and time)**. I develop ML models that perform effectively even with sparse and unevenly distributed data, as part of a broader effort to advance **AI for science**.
