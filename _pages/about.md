...
My research interests lie in understanding the properties of neural networks, with an emphasis on their transient rather than asymptotic behavior. Similar to humans, neural networks undergo [critical periods](https://en.wikipedia.org/wiki/Critical_period) where most representational structures are formed. By studying when and where networks acquire and consolidate information, I aim to improve training efficiency and model generalization.
